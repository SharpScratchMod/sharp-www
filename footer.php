<!--Footer is from http://tutorialzine.com/2015/01/freebie-5-responsive-footer-templates/-->
	...
	<div class="footer-left">
		<p class="footer-links">
			<a href="index.php">Home</a>
					·
			<a href="blog.sharpscratchmod.cf">Blog</a>
					·
			<a href="#">About</a>
					·
			<a href="#">Contact</a>
		...
		<p>&copy; 2016 Sharp Scratch Mod Developers</p>
	</div>
